...
describe('parsePageInfo', () => {
  ...
  it('should return PageInfo -object with start and end properties', () => {
    const pageInfo = parsePageInfo('138 s.');
    expect(pageInfo).to.have.keys(['start', 'end', 'str', 'total']);
  });

  it('should return PageInfo -object with correct start and end properties', () => {
    const pageInfo = parsePageInfo('138 s.');
  ...
  it('should return PageInfo -object with correct start and end properties for page ranges', () => {
  ...
  it('should return PageInfo -object with correct start and end properties for page ranges with [] -chars', () => {
  ...
  it('should prefer items that are not in parenthesis', () => {
  ...
  it('should use largest page count in the string', () => {
  ...
  it('should return null for data that contains something else than characters \'s\', \'p\', roman numerals or numbers', () => {
