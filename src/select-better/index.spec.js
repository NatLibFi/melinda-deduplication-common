...
`);
    ...
    it('should generate proper feature vector', () => {
      ...
      const vector = selectBetter.generateFeatureVector(selectBetter.generateFeatures(testRecord, featureArray));
    ...
    it('should generate proper normalized vectors', () => {
      ...
      const vector1 = selectBetter.generateFeatureVector(selectBetter.generateFeatures(testRecord, featureArray));
      const vector2 = selectBetter.generateFeatureVector(selectBetter.generateFeatures(otherTestRecord, featureArray));
